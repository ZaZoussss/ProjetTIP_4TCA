...
model = Sequential([
    ...
    layers.Conv2D(1024, kernel_size=(3, 3), activation='elu'),
    layers.MaxPooling2D((2, 2)),
    layers.Conv2D( 512, kernel_size=(5, 5), activation='elu'),
    layers.MaxPooling2D((2, 2)),
    layers.Conv2D( 256, kernel_size=(3, 3), activation='elu'),
    layers.MaxPooling2D((2, 2)),
    layers.Conv2D( 128, kernel_size=(3, 3), activation='elu'),
    layers.MaxPooling2D((2, 2)),
    layers.Flatten(),
  ...
  #layers.Conv2D(8, 3, strides=(1, 1), padding='same', data_format=None, dilation_rate=(1, 1), groups=1, activation='elu', use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, bias_constraint=None),
  ...
  #layers.Conv2D(12, 5, strides=(1, 1), padding='same', data_format=None, dilation_rate=(1, 1), groups=1, activation='elu', use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, bias_constraint=None),
  #layers.BatchNormalization(),
  #layers.ReLU(),
  #layers.MaxPooling2D(pool_size=(2, 2), strides=2),
